...
def test_data_integrity() -> None:
    ...
    # Clean files
    path = os.path.join(cfg["WORKSPACE"], f'{cfg["DATA_PATH"]}__test1__.db')
    os.remove(path)
...
def test_load_input_time() -> None:
    ...
    # Clean files
    path = os.path.join(cfg["WORKSPACE"], f'{cfg["DATA_PATH"]}__test2__.db')
    os.remove(path)
...
def test_load_latest_row() -> None:
    ...
    # Clean files
    path = os.path.join(cfg["WORKSPACE"], f'{cfg["DATA_PATH"]}__test3__.db')
    os.remove(path)
...
def test_modify_latest_row() -> None:
    ...
    # Clean files
    path = os.path.join(cfg["WORKSPACE"], f'{cfg["DATA_PATH"]}__test4__.db')
    os.remove(path)
